...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <h1 className="text-7xl font-light text-white text-architectural mb-4 reveal">
          MOHITH KANNA
        </h1>
        <p className="text-xl text-white/90 font-light tracking-wide mb-6 reveal-delayed">
          AI-Powered Solo Builder | Computer Vision (YOLO) | Automation & App Developer
        </p>
        <p className="text-lg text-white/70 font-light max-w-2xl mx-auto mb-12 reveal-delayed">
          I build AI-powered software, computer vision systems, and automation tools that replace manual workflows and ship fast.
        </p>
        
        {/* CTA Buttons */}
        <div className="flex items-center justify-center gap-4 reveal-delayed">
